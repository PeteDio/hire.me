...
<div class="overflow-auto rounded-lg shadow-md">
    <table class="w-full text-left table-auto">
        ...
        <tr>
            ...
            <td class="px-4 py-2 border-b font-semibold capitalize">${candidate.candidateStatus.name}</td>
            <td class="px-4 py-2 border-b flex items-center gap-2">
                <a href="/interview/new/${candidate.id}" class="text-blue-500 hover:underline">Schedule Interview</a>
            </td>
        </tr>
        </c:forEach>
        </c>
